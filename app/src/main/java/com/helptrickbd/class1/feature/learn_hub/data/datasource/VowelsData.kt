...
object VowelsData {
    ...
    private fun vowel(
        ...
        index: Int, tokens: List<String>
    ) = PhonicsItem(
        id = id, letter = letter, name = name, word = word, sentence = sentence,
        icon = icon, primaryColor = color, gradientColors = listOf(color, grad),
        audioAssetPath = "audio/letters/vowels/vowel_$index.mp3",
        letterAudioPath = "audio/letters/vowels/vowel_$index.mp3",
        illustrationAssetPath = "images/illustrations/illust_$index.jpg",
        sentenceAudioPath = "audio/rhymes/vowels/rhyme_$index.mp3",
        wordTokens = tokens,
